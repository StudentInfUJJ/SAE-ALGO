...
La complexité de toute méthode utilisée (de type `split()` ou `sort()`) ne devra être devra être documentée en commentaire pour indiquer la complexité générale de votre solution.
...
=== Phase 1 (deadline : **vendredi 5 juin 2026** à 19h)

* [ ] Votre ou vos algorithmes dans les dépôts adéquats sur Webetud

=== Phase 2 (deadline : **vendredi 19 juin 2026** à 19h)
